...
function displayScene() {
    ...
    display.innerHTML = `
        <div class="content-wrapper">
            ...
            <p class="content-description">以下是方案生成的西安市城区道路地图，通过抽取其中的主干道路，得到城市级路网结构。</p>
...
function displayTrafficSimulationImage() {
    ...
    imageWrapper.innerHTML = `
        ...
        <p class="content-description">路网结构包含56段双车道城市道路以及34个道路节点，每条路段设置有1个边缘计算服务器。</p>
...
function displayTrafficSimulationVideo() {
    ...
    videoWrapper.innerHTML = `
        ...
        <p class="content-description">方案利用SUMO生成城市路网并进行交通仿真。</p>
        <video autoplay muted style="max-width: 100%; max-height: 100%; object-fit: contain;" oncontextmenu="return false;">
...
function displayImage(imageIndex) {
    ...
    const images = [
        { src: 'images/2500-10.jpg' },
        { src: 'images/2500-20.jpg' },
        { src: 'images/2500-30.jpg' },
        { src: 'images/3000-10.jpg' },
        { src: 'images/3000-20.jpg' },
        { src: 'images/3000-30.jpg' }
    ];
